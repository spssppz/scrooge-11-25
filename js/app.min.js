...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: () => (/* binding */ classesToSelector)\n/* harmony export */ });\nfunction classesToSelector(classes = '') {\n  return `.${classes.trim().replace(/([\\.:!+\\/()[\\]])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://gulp_start/./node_modules/swiper/shared/classes-to-selector.mjs?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   e: () => (/* binding */ effectTarget)\n/* harmony export */ });\n/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ \"./node_modules/swiper/shared/utils.mjs\");\n\n\nfunction effectTarget(effectParams, slideEl) {\n  const transformEl = (0,_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.g)(slideEl);\n  if (transformEl !== slideEl) {\n    transformEl.style.backfaceVisibility = 'hidden';\n    transformEl.style['-webkit-backface-visibility'] = 'hidden';\n  }\n  return transformEl;\n}\n\n\n\n\n//# sourceURL=webpack://gulp_start/./node_modules/swiper/shared/effect-target.mjs?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   flsModules: () => (/* binding */ flsModules)\n/* harmony export */ });\nconst flsModules = {}\n\n//# sourceURL=webpack://gulp_start/./src/js/files/modules.js?\n}");
...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions.js */ \"./src/js/files/functions.js\");\n/* harmony import */ var _modules_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules.js */ \"./src/js/files/modules.js\");\n\r\n\r\n\r\nwindow.addEventListener('scroll', () => {\r\n\tconst bottomHeaderHeight = document.querySelector('.bottom-header').clientHeight\r\n\t// console.log(bottomHeaderHeight);\r\n\tif (window.scrollY >= 300) {\r\n\t\tdocument.body.classList.add('show-menu')\r\n\t\tif (window.innerWidth < 992) {\r\n\t\t\tdocument.body.style.paddingTop = `${bottomHeaderHeight}px`\r\n\t\t}\r\n\t} else {\r\n\t\tdocument.body.classList.remove('show-menu')\r\n\t\tif (window.innerWidth < 992) {\r\n\t\t\tdocument.body.style.paddingTop = `0px`\r\n\t\t}\r\n\t}\r\n})\r\n\r\nif (document.querySelector('.menu__link') && window.innerWidth < 992) {\r\n\tconst menuLinks = document.querySelectorAll('.menu__link')\r\n\tmenuLinks.forEach(menuLink => {\r\n\t\tmenuLink.addEventListener('click', () => {\r\n\t\t\tdocument.querySelector('.bottom-header__icon').classList.remove('_spoller-active')\r\n\t\t\t;(0,_functions_js__WEBPACK_IMPORTED_MODULE_0__._slideUp)(document.querySelector('.bottom-header__menu'), 500)\r\n\t\t})\r\n\t})\r\n}\r\n\r\nif (document.querySelector('.form-offer')) {\r\n\tconst sendForm = document.querySelector('.form-offer')\r\n\tsendForm.addEventListener('submit', async function sendFormFunc(e) {\r\n\t\te.preventDefault()\r\n\t\tconst formData = new FormData(sendForm)\r\n\t\tlet response = await fetch('files/sendmail.php', {\r\n\t\t\tmethod: \"POST\",\r\n\t\t\tbody: formData\r\n\t\t})\r\n\t\tif (response.ok) {\r\n\t\t\tsendForm.reset()\r\n\t\t\tsetTimeout(() => _modules_js__WEBPACK_IMPORTED_MODULE_1__.flsModules.popup.open('#thanks'), 100)\r\n\t\t} else {\r\n\t\t\tsetTimeout(() => _modules_js__WEBPACK_IMPORTED_MODULE_1__.flsModules.popup.open('#error'), 100)\r\n\t\t}\r\n\t})\r\n}\n\n//# sourceURL=webpack://gulp_start/./src/js/files/script.js?\n}");
